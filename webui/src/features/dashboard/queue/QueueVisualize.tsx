...
import { buildQueueTimelineChart, buildQueueTotalsChart } from './queueChartAdapters'
...
export function QueueVisualize() {
  ...
  // Turn auto-refresh off when navigating away, mirroring the Angular component's ngOnDestroy.
  useEffect(() => {
