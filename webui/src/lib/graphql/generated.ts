...
export type WorkflowFragment = { id: string, name: string, enabled: boolean, integrationId: string, matchOnRematch: boolean, createdAt: string, updatedAt: string, criteria: { contentTypes: Array<ContentType> | null, genres: Array<string> | null, languages: Array<Language> | null, videoResolutions: Array<VideoResolution> | null, videoSources: Array<VideoSource> | null, titlePatterns: Array<string> | null, sizeMin: number | null, sizeMax: number | null, minSeeders: number | null } };
...
export type CreateWorkflowMutation = { workflows: { create: { id: string, name: string, enabled: boolean, integrationId: string, matchOnRematch: boolean, createdAt: string, updatedAt: string, criteria: { contentTypes: Array<ContentType> | null, genres: Array<string> | null, languages: Array<Language> | null, videoResolutions: Array<VideoResolution> | null, videoSources: Array<VideoSource> | null, titlePatterns: Array<string> | null, sizeMin: number | null, sizeMax: number | null, minSeeders: number | null } } } };
...
export type StarTorrentMutationVariables = Exact<{
  infoHash: string;
}>;


export type StarTorrentMutation = { torrent: { putTags: void | null } };
...
export type UnstarTorrentMutationVariables = Exact<{
  infoHash: string;
}>;


export type UnstarTorrentMutation = { torrent: { deleteTags: void | null } };
...
export type UpdateWorkflowMutation = { workflows: { update: { id: string, name: string, enabled: boolean, integrationId: string, matchOnRematch: boolean, createdAt: string, updatedAt: string, criteria: { contentTypes: Array<ContentType> | null, genres: Array<string> | null, languages: Array<Language> | null, videoResolutions: Array<VideoResolution> | null, videoSources: Array<VideoSource> | null, titlePatterns: Array<string> | null, sizeMin: number | null, sizeMax: number | null, minSeeders: number | null } } } };
...
export type WorkflowsQuery = { workflows: Array<{ id: string, name: string, enabled: boolean, integrationId: string, matchOnRematch: boolean, createdAt: string, updatedAt: string, criteria: { contentTypes: Array<ContentType> | null, genres: Array<string> | null, languages: Array<Language> | null, videoResolutions: Array<VideoResolution> | null, videoSources: Array<VideoSource> | null, titlePatterns: Array<string> | null, sizeMin: number | null, sizeMax: number | null, minSeeders: number | null } }> };
...
export const StarTorrentDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"StarTorrent"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"infoHash"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Hash20"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"torrent"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"putTags"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"infoHashes"},"value":{"kind":"ListValue","values":[{"kind":"Variable","name":{"kind":"Name","value":"infoHash"}}]}},{"kind":"Argument","name":{"kind":"Name","value":"tagNames"},"value":{"kind":"ListValue","values":[{"kind":"StringValue","value":"starred","block":false}]}}]}]}}]}}]} as unknown as DocumentNode<StarTorrentMutation, StarTorrentMutationVariables>;
...
export const UnstarTorrentDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UnstarTorrent"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"infoHash"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Hash20"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"torrent"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deleteTags"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"infoHashes"},"value":{"kind":"ListValue","values":[{"kind":"Variable","name":{"kind":"Name","value":"infoHash"}}]}},{"kind":"Argument","name":{"kind":"Name","value":"tagNames"},"value":{"kind":"ListValue","values":[{"kind":"StringValue","value":"starred","block":false}]}}]}]}}]}}]} as unknown as DocumentNode<UnstarTorrentMutation, UnstarTorrentMutationVariables>;
