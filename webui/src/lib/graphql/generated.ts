...
export type CreateFavoritesListInput = {
  name: string;
};
...
export type CreateWorkflowInput = {
  ...
  enabled?: boolean | null | undefined;
  favoritesListId?: string | number | null | undefined;
  integrationId?: string | number | null | undefined;
  matchOnRematch?: boolean | null | undefined;
  name: string;
};
...
export type IntegrationActiveTorrentOrderByField =
  | 'downloadSpeed'
  | 'eta'
  | 'name'
  | 'progress'
...
export type IntegrationActiveTorrentsOrderByInput = {
  descending?: boolean | null | undefined;
  field: IntegrationActiveTorrentOrderByField;
};

export type IntegrationActiveTorrentsQueryInput = {
  limit?: number | null | undefined;
  orderBy?: IntegrationActiveTorrentsOrderByInput | null | undefined;
...
export type RenameFavoritesListInput = {
  name: string;
};

export type SetFavoriteInput = {
  favoritesListId: string | number;
  infoHash: string;
};
...
export type TorrentContentFacetsInput = {
  ...
  favoritesList?: TorrentFavoritesListFacetInput | null | undefined;
...
export type TorrentFavoritesListFacetInput = {
  aggregate?: boolean | null | undefined;
  filter?: Array<string | number> | null | undefined;
  logic?: FacetLogic | null | undefined;
};
...
export type UpdateWorkflowInput = {
  criteria?: WorkflowCriteriaInput | null | undefined;
  enabled?: boolean | null | undefined;
  favoritesListId?: string | number | null | undefined;
  integrationId?: string | number | null | undefined;
  matchOnRematch?: boolean | null | undefined;
...
export type WorkflowCriteriaInput = {
  contentTypes?: Array<ContentType> | null | undefined;
  genres?: Array<string> | null | undefined;
  languages?: Array<Language> | null | undefined;
  minSeeders?: number | null | undefined;
  sizeMax?: number | null | undefined;
  sizeMin?: number | null | undefined;
  titlePatterns?: Array<string> | null | undefined;
  videoResolutions?: Array<VideoResolution> | null | undefined;
  videoSources?: Array<VideoSource> | null | undefined;
};
...
export type FavoritesListFragment = { id: string, name: string, createdAt: string, updatedAt: string };
...
export type WorkflowFragment = { id: string, name: string, enabled: boolean, integrationId: string | null, favoritesListId: string | null, matchOnRematch: boolean, createdAt: string, updatedAt: string, criteria: { contentTypes: Array<ContentType> | null, genres: Array<string> | null, languages: Array<Language> | null, videoResolutions: Array<VideoResolution> | null, videoSources: Array<VideoSource> | null, titlePatterns: Array<string> | null, sizeMin: number | null, sizeMax: number | null, minSeeders: number | null } };

export type ApplyWorkflowToExistingMutationVariables = Exact<{
  id: string | number;
}>;


export type ApplyWorkflowToExistingMutation = { workflows: { applyToExisting: void | null } };

export type AuthCreateInitialUserMutationVariables = Exact<{
  input: CreateInitialUserInput;
}>;


export type AuthCreateInitialUserMutation = { auth: { createInitialUser: { user: { username: string } } } };
...
export type AuthLoginMutation = { auth: { login: { user: { username: string } } } };

export type AuthLogoutMutationVariables = Exact<{ [key: string]: never; }>;


export type AuthLogoutMutation = { auth: { logout: boolean } };

export type AuthUpdateCredentialsMutationVariables = Exact<{
  input: UpdateCredentialsInput;
}>;


export type AuthUpdateCredentialsMutation = { auth: { updateCredentials: { user: { username: string } } } };

export type ClearTmdbApiKeyMutationVariables = Exact<{ [key: string]: never; }>;


export type ClearTmdbApiKeyMutation = { tmdb: { clearApiKey: void | null } };

export type CreateFavoritesListMutationVariables = Exact<{
  input: CreateFavoritesListInput;
}>;


export type CreateFavoritesListMutation = { favorites: { createList: { id: string, name: string, createdAt: string, updatedAt: string } } };
...
export type CreateWorkflowMutation = { workflows: { create: { id: string, name: string, enabled: boolean, integrationId: string | null, favoritesListId: string | null, matchOnRematch: boolean, createdAt: string, updatedAt: string, criteria: { contentTypes: Array<ContentType> | null, genres: Array<string> | null, languages: Array<Language> | null, videoResolutions: Array<VideoResolution> | null, videoSources: Array<VideoSource> | null, titlePatterns: Array<string> | null, sizeMin: number | null, sizeMax: number | null, minSeeders: number | null } } } };

export type DeleteFavoritesListMutationVariables = Exact<{
  id: string | number;
}>;


export type DeleteFavoritesListMutation = { favorites: { deleteList: void | null } };
...
export type DeleteWorkflowMutation = { workflows: { delete: void | null } };
...
export type RemoveFavoriteMutation = { favorites: { remove: void | null } };

export type RenameFavoritesListMutationVariables = Exact<{
  id: string | number;
  input: RenameFavoritesListInput;
}>;


export type RenameFavoritesListMutation = { favorites: { renameList: { id: string, name: string, createdAt: string, updatedAt: string } } };
...
export type SetFavoriteMutation = { favorites: { set: void | null } };

export type SetTmdbApiKeyMutationVariables = Exact<{
  apiKey: string;
}>;


export type SetTmdbApiKeyMutation = { tmdb: { setApiKey: void | null } };
...
export type UpdateWorkflowMutation = { workflows: { update: { id: string, name: string, enabled: boolean, integrationId: string | null, favoritesListId: string | null, matchOnRematch: boolean, createdAt: string, updatedAt: string, criteria: { contentTypes: Array<ContentType> | null, genres: Array<string> | null, languages: Array<Language> | null, videoResolutions: Array<VideoResolution> | null, videoSources: Array<VideoSource> | null, titlePatterns: Array<string> | null, sizeMin: number | null, sizeMax: number | null, minSeeders: number | null } } } };

export type ArchiveEntriesQueryVariables = Exact<{
  infoHash: string;
  index: number;
}>;


export type ArchiveEntriesQuery = { torrent: { archiveEntries: Array<{ index: number, path: string, size: number, fileType: FileType | null }> } };

export type AuthStatusQueryVariables = Exact<{ [key: string]: never; }>;


export type AuthStatusQuery = { auth: { status: { setupRequired: boolean, authenticated: boolean, user: { username: string } | null } } };

export type DatabaseStatsQueryVariables = Exact<{ [key: string]: never; }>;


export type DatabaseStatsQuery = { databaseStats: { torrentsCount: number, sizeBytes: number } };

export type DbDiagnosticsQueryVariables = Exact<{ [key: string]: never; }>;


export type DbDiagnosticsQuery = { dbDiagnostics: { slowQueries: { available: boolean, unavailableReason: string | null, queries: Array<{ query: string, calls: number, totalExecMs: number, meanExecMs: number, rows: number, pctOfTotal: number }> }, tableScanStats: { tables: Array<{ tableName: string, seqScan: number, seqTupRead: number, idxScan: number, liveRows: number, seqScanRatio: number }> } } };

export type FavoritesListsQueryVariables = Exact<{ [key: string]: never; }>;


export type FavoritesListsQuery = { favoritesLists: Array<{ id: string, name: string, createdAt: string, updatedAt: string }> };
...
export type IntegrationActiveTorrentsQueryVariables = Exact<{
  id: string | number;
  input?: IntegrationActiveTorrentsQueryInput | null | undefined;
}>;


export type IntegrationActiveTorrentsQuery = { integrationActiveTorrents: { totalCount: number, items: Array<{ hash: string, name: string, progress: number, state: string, downloadSpeed: number, eta: number, size: number }> } };
...
export type TechStackQuery = { techStack: { goVersion: string, os: string, arch: string, dependencies: Array<{ name: string, version: string }> } };

export type TmdbSettingsQueryVariables = Exact<{ [key: string]: never; }>;


export type TmdbSettingsQuery = { tmdb: { hasCustomApiKey: boolean } };
...
export type WorkflowsQuery = { workflows: Array<{ id: string, name: string, enabled: boolean, integrationId: string | null, favoritesListId: string | null, matchOnRematch: boolean, createdAt: string, updatedAt: string, criteria: { contentTypes: Array<ContentType> | null, genres: Array<string> | null, languages: Array<Language> | null, videoResolutions: Array<VideoResolution> | null, videoSources: Array<VideoSource> | null, titlePatterns: Array<string> | null, sizeMin: number | null, sizeMax: number | null, minSeeders: number | null } }> };

export const FavoritesListFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"FavoritesList"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"FavoritesList"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]} as unknown as DocumentNode<FavoritesListFragment, unknown>;
...
export const WorkflowFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"Workflow"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Workflow"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"enabled"}},{"kind":"Field","name":{"kind":"Name","value":"integrationId"}},{"kind":"Field","name":{"kind":"Name","value":"favoritesListId"}},{"kind":"Field","name":{"kind":"Name","value":"matchOnRematch"}},{"kind":"Field","name":{"kind":"Name","value":"criteria"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"contentTypes"}},{"kind":"Field","name":{"kind":"Name","value":"genres"}},{"kind":"Field","name":{"kind":"Name","value":"languages"}},{"kind":"Field","name":{"kind":"Name","value":"videoResolutions"}},{"kind":"Field","name":{"kind":"Name","value":"videoSources"}},{"kind":"Field","name":{"kind":"Name","value":"titlePatterns"}},{"kind":"Field","name":{"kind":"Name","value":"sizeMin"}},{"kind":"Field","name":{"kind":"Name","value":"sizeMax"}},{"kind":"Field","name":{"kind":"Name","value":"minSeeders"}}]}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]} as unknown as DocumentNode<WorkflowFragment, unknown>;
export const ApplyWorkflowToExistingDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ApplyWorkflowToExisting"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"workflows"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"applyToExisting"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}]}]}}]}}]} as unknown as DocumentNode<ApplyWorkflowToExistingMutation, ApplyWorkflowToExistingMutationVariables>;
export const AuthCreateInitialUserDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"AuthCreateInitialUser"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CreateInitialUserInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"auth"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createInitialUser"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"username"}}]}}]}}]}}]}}]} as unknown as DocumentNode<AuthCreateInitialUserMutation, AuthCreateInitialUserMutationVariables>;
...
export const AuthUpdateCredentialsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"AuthUpdateCredentials"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UpdateCredentialsInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"auth"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateCredentials"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"username"}}]}}]}}]}}]}}]} as unknown as DocumentNode<AuthUpdateCredentialsMutation, AuthUpdateCredentialsMutationVariables>;
export const ClearTmdbApiKeyDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ClearTmdbApiKey"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"tmdb"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"clearApiKey"}}]}}]}}]} as unknown as DocumentNode<ClearTmdbApiKeyMutation, ClearTmdbApiKeyMutationVariables>;
export const CreateFavoritesListDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateFavoritesList"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CreateFavoritesListInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"favorites"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createList"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"FavoritesList"}}]}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"FavoritesList"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"FavoritesList"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]} as unknown as DocumentNode<CreateFavoritesListMutation, CreateFavoritesListMutationVariables>;
...
export const CreateWorkflowDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateWorkflow"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CreateWorkflowInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"workflows"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"create"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"Workflow"}}]}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"Workflow"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Workflow"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"enabled"}},{"kind":"Field","name":{"kind":"Name","value":"integrationId"}},{"kind":"Field","name":{"kind":"Name","value":"favoritesListId"}},{"kind":"Field","name":{"kind":"Name","value":"matchOnRematch"}},{"kind":"Field","name":{"kind":"Name","value":"criteria"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"contentTypes"}},{"kind":"Field","name":{"kind":"Name","value":"genres"}},{"kind":"Field","name":{"kind":"Name","value":"languages"}},{"kind":"Field","name":{"kind":"Name","value":"videoResolutions"}},{"kind":"Field","name":{"kind":"Name","value":"videoSources"}},{"kind":"Field","name":{"kind":"Name","value":"titlePatterns"}},{"kind":"Field","name":{"kind":"Name","value":"sizeMin"}},{"kind":"Field","name":{"kind":"Name","value":"sizeMax"}},{"kind":"Field","name":{"kind":"Name","value":"minSeeders"}}]}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]} as unknown as DocumentNode<CreateWorkflowMutation, CreateWorkflowMutationVariables>;
export const DeleteFavoritesListDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DeleteFavoritesList"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"favorites"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deleteList"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}]}]}}]}}]} as unknown as DocumentNode<DeleteFavoritesListMutation, DeleteFavoritesListMutationVariables>;
...
export const RemoveFavoriteDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"RemoveFavorite"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"infoHash"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Hash20"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"favorites"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"remove"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"infoHash"},"value":{"kind":"Variable","name":{"kind":"Name","value":"infoHash"}}}]}]}}]}}]} as unknown as DocumentNode<RemoveFavoriteMutation, RemoveFavoriteMutationVariables>;
export const RenameFavoritesListDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"RenameFavoritesList"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"RenameFavoritesListInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"favorites"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"renameList"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"FavoritesList"}}]}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"FavoritesList"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"FavoritesList"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]} as unknown as DocumentNode<RenameFavoritesListMutation, RenameFavoritesListMutationVariables>;
...
export const SetFavoriteDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SetFavorite"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"SetFavoriteInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"favorites"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"set"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}]}]}}]}}]} as unknown as DocumentNode<SetFavoriteMutation, SetFavoriteMutationVariables>;
export const SetTmdbApiKeyDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SetTmdbApiKey"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"apiKey"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"tmdb"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"setApiKey"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"apiKey"},"value":{"kind":"Variable","name":{"kind":"Name","value":"apiKey"}}}]}]}}]}}]} as unknown as DocumentNode<SetTmdbApiKeyMutation, SetTmdbApiKeyMutationVariables>;
...
export const UpdateWorkflowDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateWorkflow"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UpdateWorkflowInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"workflows"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"update"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"Workflow"}}]}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"Workflow"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Workflow"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"enabled"}},{"kind":"Field","name":{"kind":"Name","value":"integrationId"}},{"kind":"Field","name":{"kind":"Name","value":"favoritesListId"}},{"kind":"Field","name":{"kind":"Name","value":"matchOnRematch"}},{"kind":"Field","name":{"kind":"Name","value":"criteria"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"contentTypes"}},{"kind":"Field","name":{"kind":"Name","value":"genres"}},{"kind":"Field","name":{"kind":"Name","value":"languages"}},{"kind":"Field","name":{"kind":"Name","value":"videoResolutions"}},{"kind":"Field","name":{"kind":"Name","value":"videoSources"}},{"kind":"Field","name":{"kind":"Name","value":"titlePatterns"}},{"kind":"Field","name":{"kind":"Name","value":"sizeMin"}},{"kind":"Field","name":{"kind":"Name","value":"sizeMax"}},{"kind":"Field","name":{"kind":"Name","value":"minSeeders"}}]}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]} as unknown as DocumentNode<UpdateWorkflowMutation, UpdateWorkflowMutationVariables>;
export const ArchiveEntriesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"ArchiveEntries"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"infoHash"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Hash20"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"index"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"torrent"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"archiveEntries"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"infoHash"},"value":{"kind":"Variable","name":{"kind":"Name","value":"infoHash"}}},{"kind":"Argument","name":{"kind":"Name","value":"index"},"value":{"kind":"Variable","name":{"kind":"Name","value":"index"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"index"}},{"kind":"Field","name":{"kind":"Name","value":"path"}},{"kind":"Field","name":{"kind":"Name","value":"size"}},{"kind":"Field","name":{"kind":"Name","value":"fileType"}}]}}]}}]}}]} as unknown as DocumentNode<ArchiveEntriesQuery, ArchiveEntriesQueryVariables>;
...
export const DatabaseStatsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"DatabaseStats"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"databaseStats"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"torrentsCount"}},{"kind":"Field","name":{"kind":"Name","value":"sizeBytes"}}]}}]}}]} as unknown as DocumentNode<DatabaseStatsQuery, DatabaseStatsQueryVariables>;
export const DbDiagnosticsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"DbDiagnostics"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"dbDiagnostics"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"slowQueries"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"available"}},{"kind":"Field","name":{"kind":"Name","value":"unavailableReason"}},{"kind":"Field","name":{"kind":"Name","value":"queries"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"query"}},{"kind":"Field","name":{"kind":"Name","value":"calls"}},{"kind":"Field","name":{"kind":"Name","value":"totalExecMs"}},{"kind":"Field","name":{"kind":"Name","value":"meanExecMs"}},{"kind":"Field","name":{"kind":"Name","value":"rows"}},{"kind":"Field","name":{"kind":"Name","value":"pctOfTotal"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"tableScanStats"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"tables"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"tableName"}},{"kind":"Field","name":{"kind":"Name","value":"seqScan"}},{"kind":"Field","name":{"kind":"Name","value":"seqTupRead"}},{"kind":"Field","name":{"kind":"Name","value":"idxScan"}},{"kind":"Field","name":{"kind":"Name","value":"liveRows"}},{"kind":"Field","name":{"kind":"Name","value":"seqScanRatio"}}]}}]}}]}}]}}]} as unknown as DocumentNode<DbDiagnosticsQuery, DbDiagnosticsQueryVariables>;
export const FavoritesListsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"FavoritesLists"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"favoritesLists"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"FavoritesList"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"FavoritesList"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"FavoritesList"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]} as unknown as DocumentNode<FavoritesListsQuery, FavoritesListsQueryVariables>;
...
export const IntegrationActiveTorrentsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"IntegrationActiveTorrents"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"IntegrationActiveTorrentsQueryInput"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"integrationActiveTorrents"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"totalCount"}},{"kind":"Field","name":{"kind":"Name","value":"items"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"hash"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"progress"}},{"kind":"Field","name":{"kind":"Name","value":"state"}},{"kind":"Field","name":{"kind":"Name","value":"downloadSpeed"}},{"kind":"Field","name":{"kind":"Name","value":"eta"}},{"kind":"Field","name":{"kind":"Name","value":"size"}}]}}]}}]}}]} as unknown as DocumentNode<IntegrationActiveTorrentsQuery, IntegrationActiveTorrentsQueryVariables>;
...
export const TechStackDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"TechStack"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"techStack"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"goVersion"}},{"kind":"Field","name":{"kind":"Name","value":"os"}},{"kind":"Field","name":{"kind":"Name","value":"arch"}},{"kind":"Field","name":{"kind":"Name","value":"dependencies"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"version"}}]}}]}}]}}]} as unknown as DocumentNode<TechStackQuery, TechStackQueryVariables>;
export const TmdbSettingsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"TmdbSettings"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"tmdb"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"hasCustomApiKey"}}]}}]}}]} as unknown as DocumentNode<TmdbSettingsQuery, TmdbSettingsQueryVariables>;
...
export const WorkflowsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"Workflows"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"workflows"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"Workflow"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"Workflow"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Workflow"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"enabled"}},{"kind":"Field","name":{"kind":"Name","value":"integrationId"}},{"kind":"Field","name":{"kind":"Name","value":"favoritesListId"}},{"kind":"Field","name":{"kind":"Name","value":"matchOnRematch"}},{"kind":"Field","name":{"kind":"Name","value":"criteria"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"contentTypes"}},{"kind":"Field","name":{"kind":"Name","value":"genres"}},{"kind":"Field","name":{"kind":"Name","value":"languages"}},{"kind":"Field","name":{"kind":"Name","value":"videoResolutions"}},{"kind":"Field","name":{"kind":"Name","value":"videoSources"}},{"kind":"Field","name":{"kind":"Name","value":"titlePatterns"}},{"kind":"Field","name":{"kind":"Name","value":"sizeMin"}},{"kind":"Field","name":{"kind":"Name","value":"sizeMax"}},{"kind":"Field","name":{"kind":"Name","value":"minSeeders"}}]}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]} as unknown as DocumentNode<WorkflowsQuery, WorkflowsQueryVariables>;