...
export type IntegrationActiveTorrentsQuery = { integrationActiveTorrents: Array<{ hash: string, name: string, progress: number, state: string, downloadSpeed: number, eta: number, size: number }> };
