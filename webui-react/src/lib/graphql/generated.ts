...
export type ContentType = 'audiobook' | 'comic' | 'ebook' | 'game' | 'movie' | 'music' | 'software' | 'tv_show' | 'xxx'
...
export type FileType = 'archive' | 'audio' | 'data' | 'document' | 'image' | 'software' | 'subtitles' | 'video'
...
export type TorrentContentOrderByField =
  'files_count' | 'info_hash' | 'leechers' | 'name' | 'published_at' | 'relevance' | 'seeders' | 'size' | 'updated_at'
...
export type VideoSource = 'BluRay' | 'CAM' | 'DVD' | 'TELECINE' | 'TELESYNC' | 'TV' | 'WEBDL' | 'WEBRip' | 'WORKPRINT'
...
export type ContentFragment = {
  ...
  createdAt: string
  updatedAt: string
  metadataSource: { key: string; name: string }
  ...
  externalLinks: Array<{ url: string; metadataSource: { key: string; name: string } }>
}

export type QueueJobFragment = {
  id: string
  queue: string
...
export type QueueJobsQueryResultFragment = {
  totalCount: number
  ...
  aggregations: {
    queue: Array<{ value: string; label: string; count: number }> | null
    status: Array<{ value: QueueJobStatus; label: string; count: number }> | null
  }
}

export type TorrentFragment = {
  infoHash: string
  name: string
  size: number
...
export type TorrentContentFragment = {
  id: string
  infoHash: string
  contentType: ContentType | null
  title: string
  video3d: Video3D | null
  videoCodec: VideoCodec | null
  videoModifier: VideoModifier | null
  ...
  episodes: { label: string; seasons: Array<{ season: number; episodes: Array<number> | null }> } | null
}
...
export type TorrentContentSearchResultFragment = {
  ...
  aggregations: {
    contentType: Array<{ value: ContentType | null; label: string; count: number; isEstimate: boolean }> | null
    torrentSource: Array<{ value: string; label: string; count: number; isEstimate: boolean }> | null
    torrentTag: Array<{ value: string; label: string; count: number; isEstimate: boolean }> | null
    torrentFileType: Array<{ value: FileType; label: string; count: number; isEstimate: boolean }> | null
    language: Array<{ value: Language; label: string; count: number; isEstimate: boolean }> | null
    ...
    videoResolution: Array<{ value: VideoResolution | null; label: string; count: number; isEstimate: boolean }> | null
    videoSource: Array<{ value: VideoSource | null; label: string; count: number; isEstimate: boolean }> | null
  }
}
...
export type TorrentFilesQueryResultFragment = {
  totalCount: number
  hasNextPage: boolean | null
  items: Array<{
    infoHash: string
...
export type TorrentDeleteMutation = { torrent: { delete: void | null } }

export type TorrentDeleteTagsMutationVariables = Exact<{
  infoHashes?: Array<string> | string | null | undefined
  tagNames?: Array<string> | string | null | undefined
}>

export type TorrentDeleteTagsMutation = { torrent: { deleteTags: void | null } }
...
export type TorrentPutTagsMutation = { torrent: { putTags: void | null } }
...
export type TorrentSetTagsMutation = { torrent: { setTags: void | null } }
...
export type HealthCheckQuery = {
  health: {
    status: HealthStatus
    checks: Array<{ key: string; status: HealthStatus; timestamp: string; error: string | null }>
  }
  workers: { listAll: { workers: Array<{ key: string; started: boolean }> } }
}
...
export type TorrentMetricsQuery = {
  torrent: {
    metrics: { buckets: Array<{ source: string; updated: boolean; bucket: string; count: number }> }
    listSources: { sources: Array<{ key: string; name: string }> }
  }
}
...
export type TorrentSuggestTagsQuery = {
  torrent: { suggestTags: { suggestions: Array<{ name: string; count: number }> } }
}
...
export const QueueJobFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'QueueJob' },
      typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'QueueJob' } },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          ...
          { kind: 'Field', name: { kind: 'Name', value: 'runAfter' } },
          { kind: 'Field', name: { kind: 'Name', value: 'ranAt' } },
...
} as unknown as DocumentNode<QueueJobFragment, unknown>
export const QueueJobsQueryResultFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
        ...
        selections: [
          {
            ...
            selectionSet: {
              kind: 'SelectionSet',
              selections: [{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'QueueJob' } }],
            },
          },
...
} as unknown as DocumentNode<QueueJobsQueryResultFragment, unknown>
export const TorrentFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'Torrent' },
      typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'Torrent' } },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          { kind: 'Field', name: { kind: 'Name', value: 'infoHash' } },
          { kind: 'Field', name: { kind: 'Name', value: 'name' } },
          { kind: 'Field', name: { kind: 'Name', value: 'size' } },
          { kind: 'Field', name: { kind: 'Name', value: 'filesStatus' } },
          { kind: 'Field', name: { kind: 'Name', value: 'filesCount' } },
          { kind: 'Field', name: { kind: 'Name', value: 'hasFilesInfo' } },
          { kind: 'Field', name: { kind: 'Name', value: 'singleFile' } },
          ...
          { kind: 'Field', name: { kind: 'Name', value: 'leechers' } },
          { kind: 'Field', name: { kind: 'Name', value: 'tagNames' } },
          { kind: 'Field', name: { kind: 'Name', value: 'magnetUri' } },
          { kind: 'Field', name: { kind: 'Name', value: 'createdAt' } },
...
} as unknown as DocumentNode<TorrentFragment, unknown>
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          ...
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'metadataSource' },
            selectionSet: {
              kind: 'SelectionSet',
              selections: [
                { kind: 'Field', name: { kind: 'Name', value: 'key' } },
...
} as unknown as DocumentNode<ContentFragment, unknown>
export const TorrentContentFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      ...
      selectionSet: {
        ...
        selections: [
          ...
          { kind: 'Field', name: { kind: 'Name', value: 'title' } },
          {
            ...
            selectionSet: {
              kind: 'SelectionSet',
              selections: [{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'Torrent' } }],
            },
          },
          {
            kind: 'Field',
            ...
            selectionSet: {
              kind: 'SelectionSet',
              selections: [{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'Content' } }],
            },
          },
          {
            kind: 'Field',
          ...
          { kind: 'Field', name: { kind: 'Name', value: 'video3d' } },
          { kind: 'Field', name: { kind: 'Name', value: 'videoCodec' } },
          { kind: 'Field', name: { kind: 'Name', value: 'videoModifier' } },
          { kind: 'Field', name: { kind: 'Name', value: 'videoResolution' } },
          { kind: 'Field', name: { kind: 'Name', value: 'videoSource' } },
          { kind: 'Field', name: { kind: 'Name', value: 'seeders' } },
          { kind: 'Field', name: { kind: 'Name', value: 'leechers' } },
...
} as unknown as DocumentNode<TorrentContentFragment, unknown>
export const TorrentContentSearchResultFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'TorrentContentSearchResult' },
      typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'TorrentContentSearchResult' } },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
            ...
            selectionSet: {
              kind: 'SelectionSet',
              selections: [{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'TorrentContent' } }],
            },
          },
          { kind: 'Field', name: { kind: 'Name', value: 'totalCount' } },
          { kind: 'Field', name: { kind: 'Name', value: 'totalCountIsEstimate' } },
          { kind: 'Field', name: { kind: 'Name', value: 'hasNextPage' } },
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'aggregations' },
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      { kind: 'Field', name: { kind: 'Name', value: 'label' } },
                      { kind: 'Field', name: { kind: 'Name', value: 'count' } },
                      { kind: 'Field', name: { kind: 'Name', value: 'isEstimate' } },
                    ],
                  },
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'torrentSource' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      { kind: 'Field', name: { kind: 'Name', value: 'value' } },
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'torrentTag' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      { kind: 'Field', name: { kind: 'Name', value: 'value' } },
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'videoResolution' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      { kind: 'Field', name: { kind: 'Name', value: 'value' } },
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'videoSource' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      { kind: 'Field', name: { kind: 'Name', value: 'value' } },
...
} as unknown as DocumentNode<TorrentContentSearchResultFragment, unknown>
export const TorrentFileFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'TorrentFile' },
      typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'TorrentFile' } },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          { kind: 'Field', name: { kind: 'Name', value: 'infoHash' } },
...
} as unknown as DocumentNode<TorrentFileFragment, unknown>
export const TorrentFilesQueryResultFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'TorrentFilesQueryResult' },
      typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'TorrentFilesQueryResult' } },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
            ...
            selectionSet: {
              kind: 'SelectionSet',
              selections: [{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'TorrentFile' } }],
            },
          },
          { kind: 'Field', name: { kind: 'Name', value: 'totalCount' } },
          { kind: 'Field', name: { kind: 'Name', value: 'hasNextPage' } },
...
} as unknown as DocumentNode<TorrentFilesQueryResultFragment, unknown>
export const QueueEnqueueReprocessTorrentsBatchDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'QueueEnqueueReprocessTorrentsBatch' },
      variableDefinitions: [
        {
          ...
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'QueueEnqueueReprocessTorrentsBatchInput' } },
          },
        },
      ],
      selectionSet: {
...
>
export const QueuePurgeJobsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'QueuePurgeJobs' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'QueuePurgeJobsInput' } },
          },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'purgeJobs' },
                  arguments: [
                    {
                      kind: 'Argument',
                      name: { kind: 'Name', value: 'input' },
...
} as unknown as DocumentNode<QueuePurgeJobsMutation, QueuePurgeJobsMutationVariables>
export const TorrentDeleteDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'TorrentDelete' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'infoHashes' } },
          type: {
            kind: 'NonNullType',
            type: {
              kind: 'ListType',
              type: { kind: 'NonNullType', type: { kind: 'NamedType', name: { kind: 'Name', value: 'Hash20' } } },
            },
          },
        },
      ],
              ...
              selections: [
                {
                  ...
                  arguments: [
                    {
                      kind: 'Argument',
                      name: { kind: 'Name', value: 'infoHashes' },
...
} as unknown as DocumentNode<TorrentDeleteMutation, TorrentDeleteMutationVariables>
export const TorrentDeleteTagsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'TorrentDeleteTags' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'infoHashes' } },
        ...
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'tagNames' } },
          type: {
            kind: 'ListType',
...
} as unknown as DocumentNode<TorrentDeleteTagsMutation, TorrentDeleteTagsMutationVariables>
export const TorrentPutTagsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'TorrentPutTags' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'infoHashes' } },
...
} as unknown as DocumentNode<TorrentPutTagsMutation, TorrentPutTagsMutationVariables>
export const TorrentReprocessDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'TorrentReprocess' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'TorrentReprocessInput' } },
          },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'reprocess' },
                  arguments: [
                    {
                      kind: 'Argument',
                      name: { kind: 'Name', value: 'input' },
...
} as unknown as DocumentNode<TorrentReprocessMutation, TorrentReprocessMutationVariables>
export const TorrentSetTagsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'TorrentSetTags' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'infoHashes' } },
...
} as unknown as DocumentNode<TorrentSetTagsMutation, TorrentSetTagsMutationVariables>
...
export const QueueJobsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'QueueJobs' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'QueueJobsQueryInput' } },
          },
        },
      ],
      selectionSet: {
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'QueueJobsQueryResult' } }],
                  },
                },
              ],
            },
...
} as unknown as DocumentNode<QueueJobsQuery, QueueJobsQueryVariables>
export const QueueMetricsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'QueueMetrics' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'QueueMetricsQueryInput' } },
          },
        },
      ],
      selectionSet: {
                    ...
                    selections: [
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            { kind: 'Field', name: { kind: 'Name', value: 'queue' } },
                            { kind: 'Field', name: { kind: 'Name', value: 'status' } },
                            { kind: 'Field', name: { kind: 'Name', value: 'createdAtBucket' } },
                            { kind: 'Field', name: { kind: 'Name', value: 'ranAtBucket' } },
                            { kind: 'Field', name: { kind: 'Name', value: 'count' } },
...
} as unknown as DocumentNode<QueueMetricsQuery, QueueMetricsQueryVariables>
export const TorrentContentSearchDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'TorrentContentSearch' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'TorrentContentSearchQueryInput' } },
          },
        },
      ],
      selectionSet: {
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      { kind: 'FragmentSpread', name: { kind: 'Name', value: 'TorrentContentSearchResult' } },
                    ],
                  },
                },
              ],
...
} as unknown as DocumentNode<TorrentContentSearchQuery, TorrentContentSearchQueryVariables>
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'TorrentFiles' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'TorrentFilesQueryInput' } },
          },
        },
      ],
      selectionSet: {
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'TorrentFilesQueryResult' } }],
                  },
                },
              ],
            },
...
} as unknown as DocumentNode<TorrentFilesQuery, TorrentFilesQueryVariables>
export const TorrentMetricsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      ...
      variableDefinitions: [
        {
          ...
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'TorrentMetricsQueryInput' } },
          },
        },
      ],
      selectionSet: {
...
} as unknown as DocumentNode<TorrentMetricsQuery, TorrentMetricsQueryVariables>
export const TorrentSuggestTagsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'TorrentSuggestTags' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'SuggestTagsQueryInput' } },
          },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'suggestTags' },
                  arguments: [
                    {
                      kind: 'Argument',
                      name: { kind: 'Name', value: 'input' },
...
} as unknown as DocumentNode<TorrentSuggestTagsQuery, TorrentSuggestTagsQueryVariables>
