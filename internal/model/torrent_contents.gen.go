...
type TorrentContent struct {
	...
	DuplicateOfInfoHash []byte              `gorm:"column:duplicate_of_info_hash" json:"duplicateOfInfoHash"`
	DuplicatesCount     int32               `gorm:"column:duplicates_count;not null" json:"duplicatesCount"`
